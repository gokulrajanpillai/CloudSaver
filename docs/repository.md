...
Use this checklist before promoting CloudSaver publicly.

- Add current screenshots to `docs/assets/`.
...
- Keep privacy and safety claims aligned with the code.
- Avoid stale cloud-provider credential references.
